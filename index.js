...
app.post('/api/post/create', authUser, checkSchema(postValidationSchema), upload.array('content' , 10) , postCon.createPost)
...
app.delete('/api/dltPost/:postId' , authUser , authorize([ 'admin', 'moderator']) , postCon.deletePost)
